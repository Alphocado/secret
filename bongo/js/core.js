...
const InstrumentPerKeyEnum = Object.freeze({
  ...
  G: InstrumentEnum.TAMBOURINE,
  F: InstrumentEnum.COWBELL,
  Z: InstrumentEnum.MEOW,
  X: InstrumentEnum.MEOW,
  C: InstrumentEnum.MEOW,
  V: InstrumentEnum.MEOW,
  B: InstrumentEnum.MEOW,
  N: InstrumentEnum.MEOW,
  M: InstrumentEnum.MEOW,
  ",": InstrumentEnum.MEOW,
  ".": InstrumentEnum.MEOW,
  "/": InstrumentEnum.MEOW,
});
...
$.play = function (instrument, key, state) {
  ...
  if (commonKey !== undefined) {
    ...
    if (state == true) {
      ...
      if (instrument == InstrumentEnum.BONGO) {
